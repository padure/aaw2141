...
class Manufacturing_Industry_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function manufacturing_industry_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function manufacturing_industry_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function manufacturing_industry_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function manufacturing_industry_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->manufacturing_industry_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function manufacturing_industry_load( $class ) {
